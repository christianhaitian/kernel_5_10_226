cmd_drivers/video/rockchip/mpp/mpp_rkvdec2_link.o := /home/dev/Downloads/kernel_rk3562/scripts/gcc-wrapper.py aarch64-linux-gnu-gcc -Wp,-MMD,drivers/video/rockchip/mpp/.mpp_rkvdec2_link.o.d -nostdinc -isystem /opt/toolchains/gcc-linaro-6.3.1-2017.05-x86_64_aarch64-linux-gnu/bin/../lib/gcc/aarch64-linux-gnu/6.3.1/include -I./arch/arm64/include -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -mlittle-endian -DKASAN_SHADOW_SCALE_SHIFT= -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Werror=implicit-function-declaration -Werror=implicit-int -Werror=return-type -Wno-format-security -std=gnu89 -mgeneral-regs-only -Wno-psabi -mabi=lp64 -fno-asynchronous-unwind-tables -fno-unwind-tables -DKASAN_SHADOW_SCALE_SHIFT= -fno-delete-null-pointer-checks -Wno-frame-address -O2 --param=allow-store-data-races=0 -Wframe-larger-than=2048 -fstack-protector-strong -Werror -Wno-unused-but-set-variable -Wno-unused-const-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -pg -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wno-array-bounds -Wno-maybe-uninitialized -fno-strict-overflow -fno-stack-check -fconserve-stack -Werror=date-time -Werror=incompatible-pointer-types -Werror=designated-init    -DKBUILD_MODFILE='"drivers/video/rockchip/mpp/rk_vcodec"' -DKBUILD_BASENAME='"mpp_rkvdec2_link"' -DKBUILD_MODNAME='"rk_vcodec"' -D__KBUILD_MODNAME=kmod_rk_vcodec -c -o drivers/video/rockchip/mpp/mpp_rkvdec2_link.o drivers/video/rockchip/mpp/mpp_rkvdec2_link.c
